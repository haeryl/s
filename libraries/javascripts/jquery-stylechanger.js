...
/*
	...
	$(".first_color .round_color").on("click", function(){
		...
		colorpicker.linkTo(function(){
            ...
            $(".first_color .round_color").css("background-color",colorpicker.color);

			$("#font_color_1").text(".first_color .round_color, #top-menu > ul > li >ul>li:hover>.menu-item-wrap>a, #top-menu> ul > li > ul > li >ul>li:hover>.menu-item-wrap>a, #top-menu > ul > li>ul>li.current-menu-item>.menu-item-wrap>a,.info-item.clickable:hover, .folio-item .description, .hover-bg:hover, .twitter-row .icon, .twitter-row .nav a:hover, .widget_nav_menu li a:hover, .category-widget li a:hover, .button, #open-top-panel, #top-panel, div.progress .meter, .pricing-table .title, #layout .tags-widget a:hover, .tags-widget  a:hover, .breaking-news-block .blocks-label, .page-nav .older a,            .page-nav .newer a:hover, .comment-reply-link:hover, .quantity .plus, #content .quantity .plus:hover, .quantity .minus, #content .quantity .minus,            .dark-skin .twitter-row .nav a:hover, .tags-widget a:hover,#top-menu>ul>li:hover>.under,.crum_stiky_news .blocks-label,#top-menu>ul>li.current-menu-item>.menu-item-wrap {background-color:" + colorpicker.color + ';} ' +
                '.h3 span, a, .extra-links a:hover, .post header > h2 a:hover, article .dopinfo a.comments, article .dopinfo a:hover,#footer h3, .project-title a:hover, .summary .price, .dark-skin ul.accordion > li.active > div.title h5,.dark-skin .post header > h2 a:hover,.dark-skin .project-title a:hover,            .bbp-topic-meta a {color:' + colorpicker.color + ';} ' +
                '#top-menu>ul>li>ul:before {border-bottom-color:' + colorpicker.color + ';} ' +
                '#top-menu>ul>li>ul>li:first-child,  .tabs dd.active, .tabs li.active, .filter li.active, .ui-tabs .ui-tabs-nav li.ui-tabs-active, .wpb_accordion .ui-accordion .ui-accordion-header-active,#bbpress-forums ul.bbp-forums, #bbpress-forums ul.bbp-topics, #bbpress-forums ul.bbp-replies,#top-menu>ul>li>ul>li>ul>li:first-child { border-top-color:' + colorpicker.color + ';} ' +
                '.to-action-block,.tabs.vertical dd.active, .tabs.vertical li.active, .tabs.vertical dd:first-child.active, .tabs.vertical li:first-child.active, .widget_nav_menu li a:hover:before,.category-widget li a:hover:before, ul.accordion > li.active .title, .dark-skin .tabs.vertical dd.active, .dark-skin .tabs.vertical li.active, .dark-skin .to-action-block{ border-left-color:' + colorpicker.color + ';}"');
		});
	...
	$(".second_color .round_color").on("click", function(){
		...
		colorpicker.linkTo(function(){
            ...
            $(".second_color .round_color").css("background-color",colorpicker.color);

            $("#font_color_2").text(".hover-plus,.instagram-widget a span,.button:hover, #layout .tags-widget a, #footer .tags-widget a:hover, .page-nav .older a:hover,.page-nav .newer a,                .comment-reply-link,.onsale,.quantity .plus, #content .quantity .plus,.quantity .minus, #content .quantity .minus:hover,.dark-skin .tags-widget .widget-inner a:hover,            .imghover {background-color:" + colorpicker.color + ';} ' +
                'a:hover,.footer-menu a:hover,.widget_shopping_cart .amount, ul.products li.product .price,            ul.products li.product .amount {color:' + colorpicker.color + ';} ' +
                '#top-menu>ul>li>ul:before {border-bottom-color:' + colorpicker.color + ';} ' +
                'div.bbp-template-notice,.bbp-topics-front ul.super-sticky, .bbp-topics ul.super-sticky, .bbp-topics ul.sticky, .bbp-forum-content ul.sticky{ border-left-color:' + colorpicker.color + ';}"');
